//ElGamal key Generation and Signature Creation Algorithm
...
public class ElGamalAlice
{
	...
	{
		// BigIntegers are Immutable arbitrary-precision integers. They cannot be changed.
	...
	public static void main(String[] args) throws Exception 
	{
		...
		String message = sc.nextLine(); //<- We have to verify this
